...
class CalendarManagerTest {
    ...
    static void setUp() {
        ...
        calendarManager.ajouterEvent("RDV_PERSONNEL", "TITLE1", "PROPRIETAIRE1", LocalDateTime.parse("2018-05-05T11:50:55"), 30, "LIEU1", "PARTICIPANTS1", 0);
        calendarManager.ajouterEvent("PERIODIQUE", "TITLE2", "PROPRIETAIRE2", LocalDateTime.parse("2018-05-06T09:00:00"), 45, "LIEU2", "PARTICIPANTS2", 5);
        calendarManager.ajouterEvent("REUNION", "TITLE3", "PROPRIETAIRE3", LocalDateTime.parse("2018-05-10T14:30:00"), 60, "LIEU3", "PARTICIPANTS3", 1);
    }
    ...
    void test_conflit_limites_temporelles(String debutE1, int dureeE1, boolean expected) {
        ...
        Event e1 = new Event("REUNION", "TITLE1", "PROP1", dateDebutE1, dureeE1, "LIEU1", "PART1", 0);
        Event e2 = new Event("REUNION", "TITLE2", "PROP2", dateDebutE2, 30, "LIEU2", "PART2", 0);
    ...
    void test_conflit_type(String type1, String type2, boolean expected) {
        ...
        Event e1 = new Event(type1, "TITLE1", "PROP1", dateDebut, 30, "LIEU1", "PART1", 0);
        Event e2 = new Event(type2, "TITLE2", "PROP2", dateDebut, 30, "LIEU2", "PART2", 0);
